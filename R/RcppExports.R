...
rcpp_multiscale_deformable_attn <- function(value, spatial_shapes, level_start_index, sampling_loc, attn_weight, im2col_step) {
    .Call('_torchvisionlib_rcpp_multiscale_deformable_attn', PACKAGE = 'torchvisionlib', value, spatial_shapes, level_start_index, sampling_loc, attn_weight, im2col_step)
}
