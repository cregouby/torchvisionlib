...
//' Multiscale Deformable Attention Forward Pass
 ...
 // Register the operators with the TorchScript library
 // This was in the original .cpp file and is good practice to keep.
 // It allows the ops to be found by libtorch's dispatcher by name.
