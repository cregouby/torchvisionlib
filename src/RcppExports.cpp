...
torch::Tensor ms_deform_attn_forward_cpp(const torch::Tensor& value, const torch::Tensor& spatial_shapes, const torch::Tensor& level_start_index, const torch::Tensor& sampling_loc, const torch::Tensor& attn_weight, const int64_t im2col_step);
RcppExport SEXP _torchvisionlib_ms_deform_attn_forward_cpp(SEXP valueSEXP, SEXP spatial_shapesSEXP, SEXP level_start_indexSEXP, SEXP sampling_locSEXP, SEXP attn_weightSEXP, SEXP im2col_stepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const int64_t >::type im2col_step(im2col_stepSEXP);
    rcpp_result_gen = Rcpp::wrap(ms_deform_attn_forward_cpp(value, spatial_shapes, level_start_index, sampling_loc, attn_weight, im2col_step));
    return rcpp_result_gen;
END_RCPP
}
// ms_deform_attn_backward_cpp
std::vector<torch::Tensor> ms_deform_attn_backward_cpp(const torch::Tensor& value, const torch::Tensor& spatial_shapes, const torch::Tensor& level_start_index, const torch::Tensor& sampling_loc, const torch::Tensor& attn_weight, const torch::Tensor& grad_output, const int64_t im2col_step);
RcppExport SEXP _torchvisionlib_ms_deform_attn_backward_cpp(SEXP valueSEXP, SEXP spatial_shapesSEXP, SEXP level_start_indexSEXP, SEXP sampling_locSEXP, SEXP attn_weightSEXP, SEXP grad_outputSEXP, SEXP im2col_stepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const torch::Tensor& >::type value(valueSEXP);
    ...
    Rcpp::traits::input_parameter< const int64_t >::type im2col_step(im2col_stepSEXP);
    rcpp_result_gen = Rcpp::wrap(ms_deform_attn_backward_cpp(value, spatial_shapes, level_start_index, sampling_loc, attn_weight, grad_output, im2col_step));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_torchvisionlib_ms_deform_attn_forward_cpp", (DL_FUNC) &_torchvisionlib_ms_deform_attn_forward_cpp, 6},
    {"_torchvisionlib_ms_deform_attn_backward_cpp", (DL_FUNC) &_torchvisionlib_ms_deform_attn_backward_cpp, 7},
    {NULL, NULL, 0}
};
